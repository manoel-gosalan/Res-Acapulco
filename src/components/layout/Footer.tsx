      ...
      <footer className="bg-card border-t border-border pb-32 lg:pb-8">
        <div className="container-narrow section-padding">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Brand */}
            <div>
              <h3 className="text-2xl font-display text-gradient-fire mb-4">
                ACAPULCO
              </h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Take Away em Viseu. Grelhados, comida tradicional e especialidades
                do mar com entrega ao domicílio.
              </p>
            </div>
          ...
          {/* Bottom bar */}
          <div className="mt-10 pt-6 border-t border-border flex flex-col items-center gap-2 text-center text-sm text-muted-foreground">
            <p>
              © {new Date().getFullYear()} ACAPULCO Take Away. Todos os direitos
              reservados.
            </p>
